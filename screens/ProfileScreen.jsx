...
import { ConfirmModal, UpdatePasswordModel } from "../components";
        ...
        <View className="p-4 pt-10">
          <View className="flex flex-row gap-2 items-center">
            {currentUser?.picturePath ? (
              <Image
                ...
                className="w-[80px] h-[80px] rounded-full object-cover bg-[#048232]"
              />
            ) : (
              <Image
                source={{
            ...
            <View>
              <Text className="text-[25px] mb-1 font-semibold text-[#35363A] capitalize">
                {currentUser?.username}
              </Text>
              <Text className="text-[16px] text-[#ACAAAA]">
                {currentUser?.email}
              </Text>
            </View>
          </View>
          <View className="mt-8">
            ...
            <TouchableOpacity
              ...
              onPress={() => setisUpdateModalActive(true)}
            >
              <EllipsisHorizontalCircleIcon color={"#555555"} />
              <Text className="text-[16px] text-[#555555]">
                Change Password
              </Text>
            </TouchableOpacity>
            {currentUser?.status == 1 && (
              ...
              >
                <UsersIcon color={"#555555"} />
                <Text className="text-[16px] text-[#555555]">Manage Users</Text>
              </TouchableOpacity>
            )}
          </View>
