...
const HomeScreen = () => {
  return (
    <View className="relative min-h-screen mx-4 flex flex-col items-center overflow-hidden">
      ...
      <Pressable className="text-white font-semibold bg-green-600 mt-4 py-2 px-28 rounded-lg">Take a Video</Pressable>
      ...
      <View className="bg-blue-100 border border-dashed border-blue-300 mt-4 flex flex-col p-4 justify-center items-center rounded-2xl gap-3">
        ...
        <Text className="text-center text-sm">Please use this field to upload a picture if you an existing image for detection</Text>
        <Pressable className="text-white font-semibold bg-blue-600 mt-4 py-2 px-16 rounded-lg">Upload</Pressable>
      </View>
